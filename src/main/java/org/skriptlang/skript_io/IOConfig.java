...
public class IOConfig extends Config {
    ...
    public IOConfig(InputStream source, String fileName, boolean simple, boolean allowEmptySections, String defaultSeparator)
        throws IOException {
        super(source, fileName, simple, allowEmptySections, defaultSeparator);
    }
    
    public IOConfig(InputStream source, String fileName, @Nullable File file, boolean simple, boolean allowEmptySections, String defaultSeparator)
        throws IOException {
